...
export default function HeroSection({ totalListings, newToday, location }: HeroSectionProps) {
  ...
  return (
    <div className="relative overflow-hidden bg-white px-4 pt-8 pb-8 mb-4 border-b border-gray-100">
      ...
      <svg className="absolute inset-0 w-full h-full opacity-8" xmlns="http://www.w3.org/2000/svg">
        {/* Palm tree outline */}
        <g transform="translate(20, 40)" stroke="#F97316" strokeWidth="2" fill="none">
        ...
        <g transform="translate(280, 60)" stroke="#F97316" strokeWidth="2" fill="none">
        ...
        {/* Sun/star outline */}
        <g transform="translate(320, 140)" stroke="#F97316" strokeWidth="2" fill="none">
        ...
        <path d="M 0 180 Q 40 170 80 180 Q 120 190 160 180" stroke="#F97316" strokeWidth="2" fill="none" opacity="0.5" />

        {/* Bird outline */}
        <g transform="translate(60, 120)" stroke="#F97316" strokeWidth="2" fill="none">
          <path d="M -15 0 Q -8 -5 0 0 Q 8 -5 15 0" />
        </g>

        {/* Leaves */}
        <g transform="translate(200, 30)" stroke="#F97316" strokeWidth="2" fill="none">
          <path d="M 0 0 Q 10 5 15 15" />
          <path d="M 0 0 Q -10 5 -15 15" />
        </g>

        {/* Simple house (Georgetown) */}
        <g transform="translate(100, 160)" stroke="#F97316" strokeWidth="2" fill="none">
          <rect x="-10" y="0" width="20" height="15" />
          <path d="M -12 0 L 0 -8 L 12 0" />
        </g>

        {/* Mountains/hills */}
        <path d="M 0 200 L 30 175 L 60 200" stroke="#F97316" strokeWidth="2" fill="none" opacity="0.4" />
        <path d="M 250 200 L 280 180 L 310 200" stroke="#F97316" strokeWidth="2" fill="none" opacity="0.4" />
      </svg>
